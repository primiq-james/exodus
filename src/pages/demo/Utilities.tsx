      ...
      <section className="relative text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto drop-shadow">
            Manage water, sewer, trash, recycling, and other utility services in
            Exodus.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Exodus Utilities handles water supply, wastewater treatment,
                solid waste collection, and recycling for residents and
                businesses. Pay bills online, report issues, set up service, or
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 p-8 rounded-xl shadow border border-gray-200">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li>Monthly billing based on meter reading</li>
                  <li>Leak detection & conservation tips</li>
                  <li>New service setup / transfer</li>
                  <li>Water quality reports available</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow border border-gray-200">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Recycling guidelines & accepted items</li>
                  <li>Bulk waste / yard waste scheduling</li>
                  <li>Cart replacement or extra cart requests</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow border border-gray-200">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Set up autopay or paperless billing</li>
                  <li>Payment plans for past-due accounts</li>
                  <li>Late fees & disconnection policy</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow border border-gray-200">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li>Water-saving rebates & tips</li>
                  <li>Recycling rewards program</li>
                  <li>Energy & water audits</li>
                  <li>Seasonal watering restrictions</li>
                </ul>
              </div>
            </div>

            {/* How to Manage Utilities */}
            <div className="bg-teal-50 p-8 rounded-2xl border border-teal-200">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-semibold mb-3">Online Account</h3>
                  <p className="text-gray-700 mb-4">
                    View usage, pay bills, report issues, set up service, and
                    more — all in one place.
                  </p>
                  <Link
                    to="/demo/action?action=utilities_account"
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Water leak, missed pickup, or other utility problem? Submit
                    online or call 311.
                  </p>
                  <Link
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">
                    Pay or Set Up Service
                  </h3>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    <li>Online payments 24/7</li>
                    <li>Start, stop, or transfer service</li>
                    <li>Autopay & paperless options</li>
                    <li>Assistance programs available</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              ...
              >
                ...
                <p className="text-gray-600">Leaks, missed pickup, etc.</p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-600">Utilities & waste billing</p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-600">Contact Utilities Office</p>
              </Link>
            </div>
          </div>
        </div>
