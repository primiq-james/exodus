        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-teal-500 to-blue-600 flex items-center justify-center text-white text-6xl">
                🏞️
              </div>
              <div className="p-6">
            ...
            {/* News Card 2 */}
            <div className="bg-white rounded-xl overflow-hidden shadow hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-amber-500 to-red-600 flex items-center justify-center text-white text-6xl">
                📚
              </div>
              <div className="p-6">
                <div className="text-xs text-teal-600 font-medium mb-2">
            ...
            {/* News Card 3 */}
            <div className="bg-white rounded-xl overflow-hidden shadow hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-emerald-500 to-cyan-600 flex items-center justify-center text-white text-6xl">
                🛣️
              </div>
              <div className="p-6">
                <div className="text-xs text-teal-600 font-medium mb-2">
            ...
            {/* News Card 4 */}
            <div className="bg-white rounded-xl overflow-hidden shadow hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white text-6xl">
                🗳️
              </div>
              <div className="p-6">
                <div className="text-xs text-teal-600 font-medium mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-rose-500 to-pink-600 flex items-center justify-center text-white text-6xl">
                ♻️
              </div>
              <div className="p-6">
                <div className="text-xs text-teal-600 font-medium mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-blue-500 to-sky-600 flex items-center justify-center text-white text-6xl">
                🚨
              </div>
              <div className="p-6">
                <div className="text-xs text-teal-600 font-medium mb-2">
