...
export default function ResidentLibraries() {
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 relative">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-6 py-3 text-sm text-gray-600">
          ...
          <span aria-hidden="true">/</span> Libraries
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Library cards, programs, and basic resources. For exact hours
                and locations, use official city channels.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Bring an ID and proof of address (requirements can vary).
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                    <li>Check youth and educator card options.</li>
                    <li>Review card renewal and replacement guidance.</li>
                  </ul>
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Storytime, workshops, and community events change often.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link
                      to="/demo/news"
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    ...
                    <li>Computer access and printing</li>
                    <li>Homework and research resources</li>
                    <li>Wi-Fi hotspots and online learning tools</li>
                  </ul>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Need accommodations? Use the accessibility and contact
                    pages.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    School-year basics and youth programs.
                  </p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Youth resources and local programs.
                  </p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Groups, meetings, and local updates.
                  </p>
                </Link>
              </div>
            </aside>
