...
export default function ResidentFamilies() {
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 relative">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-6 py-3 text-sm text-gray-600">
          ...
          <span aria-hidden="true">/</span> Families
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-700 mb-8">
                A starting point for family needs: youth programming, community
                resources, and how to find the right city contact.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Seasonal classes, camps, and events change often. Use city
                    announcements for updates.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                    <li>Community center programming by age and season.</li>
                    <li>Low-cost and adaptive recreation options.</li>
                  </ul>
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Storytime, workshops, and digital access.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                    <li>Early literacy and family reading support.</li>
                    <li>Homework, STEM, and technology access resources.</li>
                  </ul>
                  <div className="flex flex-wrap gap-3">
                    <Link
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Waste pickup, neighborhood issues, and pet services.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                    <li>Missed pickup and cart replacement pathways.</li>
                    <li>Neighborhood reporting and service-request routing.</li>
                  </ul>
                  <div className="flex flex-wrap gap-3">
                    <Link
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    If you are unsure where to start, begin with 311 for
                    routing, or contact the city for staff support.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Local groups, meetings, and updates.
                  </p>
                </Link>
                <Link
                  to="/demo/resident/education"
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    School-year basics and youth resources.
                  </p>
                </Link>
                <Link
                  to="/demo/resident/libraries"
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Programs, cards, and digital access.
                  </p>
                </Link>
              </div>
            </aside>
