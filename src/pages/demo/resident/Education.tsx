...
export default function ResidentEducation() {
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Quick links for common school-year needs: registrations, youth
                programs, and where to look for schedules and announcements.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    <li>Verify your address and campus boundaries.</li>
                    <li>Gather proof of residency and immunization records.</li>
                    <li>Check transportation options and start dates.</li>
                    <li>
                      Review enrollment windows, transfers, and waitlists.
                    </li>
                  </ul>
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    After-school activities, camps, and community programming
                    vary by season.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                    <li>Find youth sports, arts, and STEM program options.</li>
                    <li>
                      Check scholarship or reduced-fee program eligibility.
                    </li>
                  </ul>
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Homework help, reading programs, and community learning
                    resources.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                    <li>Homework labs and tutoring support by age group.</li>
                    <li>Digital literacy and job-readiness workshops.</li>
                  </ul>
                  <div className="flex flex-wrap gap-3">
                    <Link
                ...
                <div className="rounded-xl border border-gray-200 bg-gray-50 p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    For weather, closures, and safety guidance, use official
                    channels and city updates.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Locations, cards, and learning programs.
                  </p>
                </Link>
                <Link
                  to="/demo/resident/families"
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Recreation, youth, and caregiver info.
                  </p>
                </Link>
                <Link
                  to="/demo/news"
                  className="block rounded-lg bg-white border border-gray-200 p-4 hover:border-teal-300 hover:shadow-sm transition"
                >
                  <p className="font-bold text-teal-700">City News</p>
                  <p className="text-sm text-gray-600">
                    Closures, updates, and announcements.
                  </p>
                </Link>
              </div>
            </aside>
